...
static CFStringRef settingsChangedNotification = CFSTR("com.esehr.proxyswitcher/settingschanged");
...
- (void)contactMe {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:mbo@esehr.com"]];
}

- (void)sendFeedback {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:mbo@esehr.com?subject=ProxySwitcher"]];
}
